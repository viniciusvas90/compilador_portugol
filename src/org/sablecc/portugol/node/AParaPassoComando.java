...
public final class AParaPassoComando extends PComando
{
    ...
    public AParaPassoComando(
        ...
        @SuppressWarnings("hiding") TNumeroInt _passoo_,
    ...
    public TNumeroInt getPassoo()
    {
        return this._passoo_;
    }

    public void setPassoo(TNumeroInt node)
    {
        if(this._passoo_ != null)
        {
            this._passoo_.parent(null);
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._passoo_ == oldChild)
        {
            setPassoo((TNumeroInt) newChild);
            return;
        }
